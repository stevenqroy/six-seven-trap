...
export const SCENE = {
  ...
  DANGER_BEAM_ORIGIN_Y_RATIO: 0.61,
  DANGER_BEAM_PORTAL_Y_MIN: 7,
  DANGER_BEAM_WIDTH_AMP_A: 0.65,
  DANGER_BEAM_WIDTH_AMP_B: 0.35,
  DANGER_BEAM_LEN_OSC_A_MULT: 0.72,
  DANGER_BEAM_LEN_OSC_B_MULT: 0.53,
  DANGER_BEAM_LEN_OSC_A_WEIGHT: 0.7,
  DANGER_BEAM_LEN_OSC_B_WEIGHT: 0.3,
  DANGER_BEAM_BOTTOM_WIDTH_BASE: 1.14,
  DANGER_BEAM_BOTTOM_WIDTH_MOD: 0.34,
  DANGER_BEAM_BOTTOM_WIDTH_SIN: 0.16,
  // Danger beam embers
  DANGER_EMBER_SPAWN_Y_MIN: 0.03,
  DANGER_EMBER_SPAWN_Y_RANGE: 0.16,
  DANGER_EMBER_SPAWN_X_BASE: 0.34,
  DANGER_EMBER_SPAWN_X_RANGE: 0.18,
  DANGER_EMBER_VX_SPREAD_BASE: 42,
  DANGER_EMBER_VX_SPREAD_RANGE: 52,
  DANGER_EMBER_VY_BASE: 140,
  DANGER_EMBER_VY_RANGE: 170,
  DANGER_EMBER_R_MIN: 0.75,
  DANGER_EMBER_R_RANGE: 1.55,
  DANGER_EMBER_LIFE_MIN: 1.15,
  DANGER_EMBER_LIFE_RANGE: 1.25,
  DANGER_EMBER_HUE_MIN: 28,
  DANGER_EMBER_HUE_RANGE: 26,
  DANGER_EMBER_GRAVITY: 480,
  DANGER_EMBER_DRAG: 0.992,
  DANGER_EMBER_BOUNCE_VX_JITTER: 58,
  DANGER_EMBER_BOUNCE_VY_MIN: 85,
  DANGER_EMBER_BOUNCE_VY_RANGE: 120,
  DANGER_EMBER_BOUNCE_VY_CAP: -190,
  DANGER_EMBER_BOUNCE_VX_DAMP: 0.88,
  DANGER_EMBER_BOUNCE_VY_DAMP: 0.68,
  DANGER_EMBER_BOTTOM_FADE_RATIO: 0.88,
  DANGER_EMBER_BOTTOM_FADE_RATE: 1.8,
  DANGER_EMBER_MAX_BOUNCES: 8,
  DANGER_EMBER_OFFSCREEN_PAD: 42,
  DANGER_EMBER_CAP_MIN: 40,
  // Danger sizzles
  DANGER_SIZZLE_COUNT_BASE: 2,
  DANGER_SIZZLE_COUNT_RANGE: 3,
  DANGER_SIZZLE_SPEED_BASE: 34,
  DANGER_SIZZLE_SPEED_RANGE: 54,
  DANGER_SIZZLE_R_MIN: 0.55,
  DANGER_SIZZLE_R_RANGE: 1.1,
  DANGER_SIZZLE_LIFE_MIN: 0.12,
  DANGER_SIZZLE_LIFE_RANGE: 0.16,
  DANGER_SIZZLE_HUE_MIN: 26,
  DANGER_SIZZLE_HUE_RANGE: 24,
  DANGER_SIZZLE_GRAVITY: 260,
  DANGER_SIZZLE_VX_DRAG: 0.94,
  DANGER_SIZZLE_VY_DRAG: 0.92,
  DANGER_SIZZLE_CAP_MIN: 20,
