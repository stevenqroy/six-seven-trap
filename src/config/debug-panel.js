...
function renderPanelContent() {
  ...
  const flagGroups = {
    ...
    'Phase 6: Guardian Command': ['actionBar', 'actionInputArbitration', 'multiTouchAction', 'guardianActiveMoves', 'commandEnergy', 'supportFramework', 'supportMedicFirefly', 'supportBulwarkBot', 'supportStrikerHawk'],
