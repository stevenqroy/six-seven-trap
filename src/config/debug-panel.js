...
function renderPanelContent() {
  ...
  const flagGroups = {
    ...
    'Phase 6: Guardian Command': ['actionBar', 'actionInputArbitration', 'guardianActiveMoves', 'commandEnergy', 'supportFramework', 'supportMedicFirefly', 'supportBulwarkBot', 'supportStrikerHawk'],
