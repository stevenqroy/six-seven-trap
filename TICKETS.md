...
| 26 | S7R-060 | Reduce per-frame GPU allocations | — | no | codex | wip:codex | codex/S7R-060 | codex |
...
| S7R-060 | Cache/pool gradient objects, gate `shadowBlur` behind quality tier, cache static sky/hill gradients. | wip:codex | codex |
...
## main.js Lock
**Currently held by**: `wip:codex (S7R-060)`
