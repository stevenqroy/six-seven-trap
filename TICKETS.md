...
| 25 | S7R-059 | Cap danger-mode particles | — | no | gemini | review | gemini/S7R-059 | gemini |
...
| S7R-059 | Hard-cap danger embers + sizzles. Without adaptive quality, both default to `Infinity`. Spawn rate 280/sec compounds. | review | claude |
